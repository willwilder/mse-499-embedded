        ...
        try:
            while self.alive and self._reader_alive:
                ...
                if (not self.previous_process_runnning and self.process_running):
                    print "rising edge"
                    self.current_csv_path = os.getcwd()+"/data/"+str(time.time())+"data.csv"
                ...
                #print ("Process Running:"+str(self.process_running))
